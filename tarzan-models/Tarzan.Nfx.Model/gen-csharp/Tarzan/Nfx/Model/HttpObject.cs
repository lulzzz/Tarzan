...
namespace Tarzan.Nfx.Model
{
  ...
  [Serializable]
  #endif
  public partial class HttpObject : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("HttpObject");
        ...
        if (ObjectIndex != null && __isset.ObjectIndex) {
          field.Name = "ObjectIndex";
          field.Type = TType.String;
          field.ID = 2;
          oprot.WriteFieldBegin(field);
          oprot.WriteString(ObjectIndex);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("HttpObject(");
      bool __first = true;
      if (FlowUid != null && __isset.FlowUid) {
